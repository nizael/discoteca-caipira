export const AlbumCard = ({name, releaseYear, id}:{releaseYear: number, name: string, id: number}) => {
  const urlImg = 'https://blog.cowboystore.com.br/wp-content/uploads/2018/04/tiao-carreiro-e-pardinho-m%C3%BAsicas.png'
  return (
    <a href={`/album-view/${id}`} className="bg-white w-fit shadow flex flex-col gap-4 items-center">
